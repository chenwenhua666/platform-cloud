/*
 ...
 Source Schema         : platform_cloud_base_v2
...
-- ----------------------------
INSERT INTO `t_eximport` VALUES ('字段1', 1, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 2, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 3, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 4, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 5, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 6, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 7, '764471698@qq.com', '2019-07-25 19:08:01');
INSERT INTO `t_eximport` VALUES ('字段1', 8, '764471698@qq.com', '2019-07-25 19:08:01');
...
-- ----------------------------
INSERT INTO `t_generator_config` VALUES (1, 'crystal', 'com.plm.platform.server.foundation', 'entity', 'mapper', 'mapper', 'service', 'service.impl', 'controller', '1', 't_');
...
INSERT INTO `t_job` VALUES (3, 'taskList', 'test2', '{\"name\":\"star\",\"age\":18}', '0/1 * * * * ?', '1', 'JSON类型参数任务测试', '2018-02-26 09:28:26');
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '调度日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_logger`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分布式事务日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_menu` VALUES (10, 2, '系统日志', '/monitor/systemlog', 'platform/monitor/systemlog/Index', 'log:view', '', '0', 2, '2017-12-27 17:00:50', '2020-04-13 11:38:04');
...
INSERT INTO `t_menu` VALUES (180, 2, '监控面板', '/monitor/dashboard', 'platform/monitor/dashboard/Index', 'monitor:dashboard', '', '0', 1, '2020-04-13 09:44:09', '2020-04-13 11:38:00');
INSERT INTO `t_menu` VALUES (182, 154, '数据权限', '/others/datapermission', 'platform/others/datapermission/Index', 'others:datapermission', '', '0', 3, '2020-04-14 14:51:35', '2020-04-14 15:37:19');
INSERT INTO `t_menu` VALUES (183, 0, '任务调度', '/job', 'Layout', '', 'el-icon-alarm-clock', '0', 5, '2020-04-14 18:39:35', '2020-04-14 18:39:53');
INSERT INTO `t_menu` VALUES (184, 183, '任务列表', '/job/list', 'platform/job/job/Index', 'job:view', '', '0', 1, '2020-04-14 18:40:37', '2020-04-14 18:41:36');
INSERT INTO `t_menu` VALUES (185, 183, '调度日志', '/job/log', 'platform/job/log/Index', 'job:log:view', '', '0', 2, '2020-04-14 18:42:25', NULL);
...
INSERT INTO `t_role` VALUES (2, '注册用户', '可查看，新增，导出', '2019-01-04 14:11:28', '2020-05-06 14:10:45');
INSERT INTO `t_role` VALUES (3, '系统监控员', '负责系统监控模块', '2019-09-01 10:30:25', '2020-05-06 14:10:13');
...
CREATE TABLE `t_trade_log`  (
  ...
  `CREATE_TIME` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分布式事务测试' ROW_FORMAT = Dynamic;
