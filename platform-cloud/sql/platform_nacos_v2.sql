...
INSERT INTO `config_info` VALUES (29, 'platform-tx-manager.yaml', 'DEFAULT_GROUP', 'server:\r\n  port: 8501\r\nspring:\r\n  boot:\r\n    admin:\r\n      client:\r\n        url: http://${platform-admin}:8401\r\n        username: platform\r\n        password: 123456a_\r\n        instance:\r\n          prefer-ip: true\r\n  datasource:\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://${mysql.url}:3306/platform_cloud_base_v2?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2b8\r\n    username: root\r\n    password: 123456\r\n  redis:\r\n    database: 0\r\n    host: ${redis.url}\r\n    port: 6379\r\n    lettuce:\r\n      pool:\r\n        min-idle: 8\r\n        max-idle: 500\r\n        max-active: 2000\r\n        max-wait: 10000\r\n    timeout: 5000\r\n\r\ninfo:\r\n  app:\r\n    name: ${spring.application.name}\r\n    description: \"@project.description@\"\r\n    version: \"@project.version@\"\r\n\r\nmanagement:\r\n  endpoints:\r\n    web:\r\n      exposure:\r\n        include: \'*\'\r\n  endpoint:\r\n    health:\r\n      show-details: ALWAYS\r\n\r\ntx-lcn:\r\n  manager:\r\n    host: 127.0.0.1\r\n    # TM监听Socket端口.\r\n    port: 8888\r\n    # TM控制台密码\r\n    admin-key: 123456a_\r\n  logger:\r\n    # 开启日志记录\r\n    enabled: true\r\n    driver-class-name: ${spring.datasource.driver-class-name}\r\n    jdbc-url: ${spring.datasource.url}\r\n    username: ${spring.datasource.username}\r\n    password: ${spring.datasource.password}', '874a21785c1200d56bdfdf0070f8f20f', '2020-04-16 09:12:35', '2020-05-06 10:09:22', NULL, '127.0.0.1', '', '', 'tx-lcn管理端配置', 'null', 'null', 'yaml', 'null');
...
INSERT INTO `config_info` VALUES (83, 'platform-auth.yaml', 'DEFAULT_GROUP', 'server:\r\n  port: 8101\r\nspring:\r\n  datasource:\r\n    dynamic:\r\n      hikari:\r\n        connection-timeout: 30000\r\n        max-lifetime: 1800000\r\n        max-pool-size: 15\r\n        min-idle: 5\r\n        connection-test-query: select 1\r\n        pool-name: PlatformHikariCP\r\n      primary: base\r\n      datasource:\r\n        base:\r\n          username: root\r\n          password: 123456\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://${mysql.url}:3306/platform_cloud_base_v2?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2b8\r\n\r\n  jackson:\r\n    date-format: yyyy-MM-dd HH:mm:ss\r\n    time-zone: GMT+8\r\n  boot:\r\n    admin:\r\n      client:\r\n        url: http://${platform-admin}:8401\r\n        username: platform\r\n        password: 123456a_\r\n        instance:\r\n          prefer-ip: true\r\n\r\n  redis:\r\n    database: 0\r\n    host: ${redis.url}\r\n    port: 6379\r\n    lettuce:\r\n      pool:\r\n        min-idle: 8\r\n        max-idle: 500\r\n        max-active: 2000\r\n        max-wait: 10000\r\n    timeout: 5000\r\nmybatis-plus:\r\n  type-aliases-package: com.plm.platform.common.core.entity.system\r\n  mapper-locations: classpath:mapper/*.xml\r\n  configuration:\r\n    jdbc-type-for-null: null\r\n  global-config:\r\n    banner: false\r\ninfo:\r\n  app:\r\n    name: ${spring.application.name}\r\n    description: \"@project.description@\"\r\n    version: \"@project.version@\"\r\n\r\nmanagement:\r\n  endpoints:\r\n    web:\r\n      exposure:\r\n        include: \'*\'\r\n  endpoint:\r\n    health:\r\n      show-details: ALWAYS\r\n\r\njustauth:\r\n  enabled: true\r\n  type:\r\n    github:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n    gitee:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n    tencent_cloud:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n    dingtalk:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n    qq:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n    microsoft:\r\n      client-id: \r\n      client-secret: \r\n      redirect-uri: \r\n  cache:\r\n    type: redis\r\n    prefix: \'PLM::CLOUD::SOCIAL::STATE::\'\r\n    timeout: 1h\r\n\r\nplatform:\r\n  frontUrl: \'http://localhost:9527\'\r\n  doc:\r\n    enable: true\r\n    title: ${spring.application.name}文档\r\n    base-package: com.plm.platform.auth.controller\r\n    description: ${platform.doc.title}\r\n    name: crystal\r\n    email: 764471698@qq.com\r\n    url: http://47.105.198.196\r\n    version: 2.0-RELEASE\r\n  cloud:\r\n    security:\r\n      enable: true\r\n      anon-uris: /actuator/**,/captcha,/social/**,/v2/api-docs,/v2/api-docs-ext', 'a822df29913489b4d6e70d8dbcc0b524', '2020-04-18 10:01:55', '2020-05-05 13:57:24', NULL, '127.0.0.1', '', '', 'platform-auth微服务配置', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info` VALUES (89, 'platform-gateway-prod.yaml', 'DEFAULT_GROUP', 'server:\r\n  port: 8301\r\nspring:\r\n  cloud:\r\n    gateway:\r\n      globalcors:\r\n        corsConfigurations:\r\n          \'[/**]\':\r\n            allowedOrigins: \"*\"\r\n            allowedMethods: \"*\"\r\n            allowedHeaders: \"*\"\r\n            allowCredentials: true\r\n      routes:\r\n        - id: platform-auth-social\r\n          uri: lb://platform-auth\r\n          predicates:\r\n            - Path=/auth/social/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: socialfallback\r\n                fallbackUri: forward:/fallback/platform-auth\r\n        - id: platform-auth\r\n          uri: lb://platform-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: authfallback\r\n                fallbackUri: forward:/fallback/platform-auth\r\n        - id: platform-server-system\r\n          uri: lb://platform-server-system\r\n          predicates:\r\n            - Path=/system/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: systemfallback\r\n                fallbackUri: forward:/fallback/platform-server-system\r\n        - id: platform-server-generator\r\n          uri: lb://platform-server-generator\r\n          predicates:\r\n            - Path=/generator/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: generatorfallback\r\n                fallbackUri: forward:/fallback/platform-server-generator\r\n        - id: platform-server-job\r\n          uri: lb://platform-server-job\r\n          predicates:\r\n            - Path=/job/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: jobfallback\r\n                fallbackUri: forward:/fallback/platform-server-job\r\n        - id: platform-server-foundation\r\n          uri: lb://platform-server-foundation\r\n          predicates:\r\n            - Path=/foundation/**\r\n          filters:\r\n            - name: Hystrix\r\n              args:\r\n                name: foundationfallback\r\n                fallbackUri: forward:/fallback/platform-server-foundation\r\n      loadbalancer:\r\n        use404: true\r\n      default-filters:\r\n        - StripPrefix=1\r\n        - PlatformDocGatewayHeaderFilter\r\n  autoconfigure:\r\n    exclude: org.springframework.boot.autoconfigure.mongo.MongoReactiveAutoConfiguration,org.springframework.boot.autoconfigure.data.mongo.MongoReactiveRepositoriesAutoConfiguration,org.springframework.boot.autoconfigure.mongo.MongoAutoConfiguration\r\n\r\n  # data:\r\n    # mongodb:\r\n      # host: ${mongo.url}\r\n      # port: 27017\r\n      # database: platform_cloud_route_v2\r\n\r\n  redis:\r\n    database: 3\r\n    host: ${redis.url}\r\n    port: 6379\r\n    lettuce:\r\n      pool:\r\n        min-idle: 8\r\n        max-idle: 500\r\n        max-active: 2000\r\n        max-wait: 10000\r\n    timeout: 5000\r\n\r\nplatform:\r\n  gateway:\r\n    enhance: false\r\n    jwt:\r\n      secret: 123456788\r\n      expiration: 36000\r\n  doc:\r\n    gateway:\r\n      enable: true\r\n      resources: \"platform-server-system,platform-server-foundation,platform-auth,platform-server-generator,platform-server-job\"\r\n\r\nhystrix:\r\n  command:\r\n    default:\r\n      execution:\r\n        isolation:\r\n          thread:\r\n            timeoutInMilliseconds: 10000\r\n    socialfallback:\r\n      execution:\r\n        isolation:\r\n          thread:\r\n            timeoutInMilliseconds: 60000\r\n\r\nribbon:\r\n  eager-load:\r\n    enabled: true\r\n\r\nmanagement:\r\n  endpoint:\r\n    health:\r\n      show-details: ALWAYS\r\n  endpoints:\r\n    web:\r\n      exposure:\r\n        include: health,info,gateway', '7c35ab8d20afd11984798a3cd51bc377', '2020-05-05 11:54:41', '2020-05-05 11:54:41', NULL, '127.0.0.1', '', '', 'platform-gateway-prod网关配置', NULL, NULL, 'yaml', NULL);
