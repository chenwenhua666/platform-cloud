package com.plm.platform.server.job.configure;
...
public class PlatformJobConfigure {
    ...
    public ThreadPoolTaskExecutor scheduleJobExecutorService() {
        ...
        executor.setThreadNamePrefix("Platform-Job-Thread");
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "PlmCloudScheduler");
        ...
        factory.setSchedulerName("PLM_Cloud_Scheduler");
        // 延时启动
