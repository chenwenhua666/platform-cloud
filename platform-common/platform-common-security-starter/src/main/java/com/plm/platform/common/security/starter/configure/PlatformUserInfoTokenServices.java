 ...
 * @author crystal
 */
public class PlatformUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public PlatformUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
