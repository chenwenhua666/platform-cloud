package com.plm.platform.common.doc.starter.properties;
 ...
 * @author crystal
 */
@ConfigurationProperties(prefix = "platform.doc")
public class PlatformDocProperties {
