package com.plm.platform.common.doc.gateway.handler;
 ...
 */
@RestController
public class PlatformDocGatewayHandler {

    private SecurityConfiguration securityConfiguration;
    private UiConfiguration uiConfiguration;
    private SwaggerResourcesProvider swaggerResources;
    private PlatformDocGatewayProperties properties;
    ...
    public void setProperties(PlatformDocGatewayProperties properties) {
