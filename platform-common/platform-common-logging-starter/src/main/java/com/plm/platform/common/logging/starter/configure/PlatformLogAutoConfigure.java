package com.plm.platform.common.logging.starter.configure;

import com.plm.platform.common.logging.starter.aspect.ControllerLogAspect;
import com.plm.platform.common.logging.starter.properties.PlatformLogProperties;
...
public class PlatformLogAutoConfigure {
    private final PlatformLogProperties properties;

    @Value("${spring.application.name}")
    private String applicationName;

    public PlatformLogAutoConfigure(PlatformLogProperties properties) {
    ...
    @ConditionalOnProperty(name = "platform.log.enable-log-for-controller", havingValue = "true")
    @Bean
    public ControllerLogAspect controllerLogAspect(){
        return new ControllerLogAspect();
    }

    @ConditionalOnProperty(name = "platform.log.enable-elk", havingValue = "true")
    @Bean
